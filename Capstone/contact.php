    ...
    <head>
        ...
        <script>
            $(document).ready(function(){
                ...
                //Send an email to admin by validating the email subject and body
                $("#contactButton").click(function(){
                    ...
                    if(subject == ''){
                        swal('Error', 'Subject is Required', 'error');
                    }else if(body == ''){
                        swal('Error', 'Body is Required', 'error');
                    }else{
                        window.location.href = 'mailto:kathakkar1999@gmail.com?subject='+subject+'&body='+body;
                    }
                });
            });
        </script>
    ...
    <body>
        ...
        <div class="container" id="main">
            ...
            <?php
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" id="contactButton">Contact</button>
